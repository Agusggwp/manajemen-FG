...
<head>
    ...
    <title>Pengingat Tugas MUA H-1</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Pengingat Tugas MUA (H-1)</h1>
            <p>ARTDEVATA Photography Management</p>
        </div>

        <div class="content">
            <div class="greeting">Halo, {{ $mua->name }}!</div>
            <div class="intro">
                Ini adalah pengingat bahwa Anda ditugaskan sebagai <strong>Make Up Artist (MUA)</strong> untuk sesi pemotretan yang akan dilaksanakan <strong>besok</strong>. Mohon persiapkan peralatan rias Anda.
            </div>

            <div class="card">
                <div class="card-title">Informasi Sesi & Klien</div>
            ...
            @if($schedule->project && $schedule->project->photographers->count() > 0)
            <div class="card">
                <div class="card-title">Tim Fotografer</div>
                <div class="detail-row">
            ...
            <p class="intro" style="margin-bottom: 0;">
                Terima kasih atas kerja samanya. Sampai jumpa di lokasi pemotretan besok!
            </p>
        </div>
